                            ...
                            <div slot="body">
                                <div class="table">
                                    <div class="table-responsive">
                                        {{-- <form action="/testttttttttttt" method="post">
                                            <form action="{{ route('admin.sales.orders.comment', $order->id) }}" method="post" @submit.prevent="onSubmit">
                                            <button type="submit">test</button>
                                                @csrf()
                                        </form> --}}
                                        {{-- <form action="{{ route('admin.sales.carts.cartItemEdit', $item->id) }}" method="POST"> --}}
                                        <form action="../cartItemEdit/{{$item->id}}" method="POST">
                                            {{ csrf_field() }}
                                            <table>
                                                <thead>
                                                    <tr>
                                                ...
                                                <tbody>
                                                    @foreach ($order->items as $item)
                                                        {{-- <form action="/testttttttttttttttttt" method="POST" @submit.prevent="onSubmit"> --}}
                                                            {{-- <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}"> --}}
                                                            <tr>
                                                                {{-- <form action="/testttttttttttt" method="post" @submit.prevent="onSubmit"> --}}
                                                                    {{-- <form action="{{ route('admin.sales.orders.comment', $order->id) }}" method="post" @submit.prevent="onSubmit"> --}}
                                                                        {{-- @csrf() --}}
                                                                {{-- <td>
                                                                ...
                                                                <td>
                                                                    <input type="text" name="someName" value= "{{$item->name}}" />
                                                                ...
                                                                <td><input type="text" name="price{{$item->id}}" id="" value="{{ core()->formatBasePrice($item->base_price) }}"></td>
                                                                ...
                                                                <td><input type="text" name="" id="" value="{{ $item->tax_percent }}%"></td>
                                                                ...
                                                                <td>
                                                                    <button type="submit" class="btn btn-lg btn-primary" style="border-radius: .5rem; font-size: 1rem; font-weight: bold; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">ویرایش</button>
                                                                </td>
                                                            </tr>
