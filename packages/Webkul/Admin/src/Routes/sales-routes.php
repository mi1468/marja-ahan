...
Route::group(['middleware' => ['web', 'admin'], 'prefix' => config('app.admin_url')], function () {
    Route::prefix('sales')->group(function () {
        ...
        // MEEEEEEEEEEEEEEEE sales route
        
        Route::get('/cart', [CartController::class, 'index'])->defaults('_config', [
            'view' => 'admin::sales.carts.index',
        ])->name('admin.sales.carts.index');

        // end MEEEEEEEEEEEEEEEEEEE
  ...
  // MEEEEEEEEEEEEEEEE sales route
        ...
        Route::get('/cart/view/{id}', [CartController::class, 'view'])->defaults('_config', [
            'view' => 'admin::sales.carts.view',
        ])->name('admin.sales.carts.view');
        
        Route::get('/cart/cartItemShow/{id}', [CartController::class, 'cartItemShow'])->defaults('_config', [
            'view' => 'admin::sales.carts.cartItemEdit',
        ])->name('admin.sales.carts.cartItemShow');

        Route::post('/cart/cartItemEdit/{id}', [CartController::class, 'updateCartItem'])->defaults('_config', [
            'view' => 'admin::sales.carts.cartItemEdit',
        ])->name('admin.sales.carts.cartItemEdit');
 // end MEEEEEEEEEEEEEEEEEEE
